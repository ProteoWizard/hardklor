...
class CHardklorSetting {
 ...
 public:
  ...
  bool reportAveragineAndMassOffset; // For Skyline use - when true, add averagine formula and mass offset to output e.g. H21C14N4O4[+3.038518]
  ...
  int minIsotopePeaks; //  For Skyline use - must identify at least this many isotope peaks in a feature for it to be included in report
